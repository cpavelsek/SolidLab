...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        //CHRIS CODE - instantiate your ListReader class and run it
        Reader readList = new ListReader();

        readList.readln();

        //CHRIS CODE - instantiate ListWriter and run it
        Writer writeList = new ListWriter();

        writeList.writeln("Cats");
    }
}
